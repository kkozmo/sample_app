...
class UserTest < ActiveSupport::TestCase
  ...
  def setup
	...
	test "email validation should reject invalid addreses" do
		invalid_addresses = %w[user@example,net user_at_foo.org user.name@example. foo@bar_baz.com foo@bar+baz.com foo@bar..com]
  ...
  test "should follow and unfollow a user" do
    ...
    assert archer.followers.include?(kyle)
